...
/* Here I had to hardcode the date to match the expected date to be tested, 
since I'm brazilian and my timezone was returning the given date one day earlier
*/
const getDate = (date) => {
  if (!date) {
